...
# 环境变量
UUID = os.environ.get('UUID', 'd561401c-a8d7-4614-8fa5-fadf37a3c066')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'deployzy.5785787.xyz')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'deployzy')                    # 节点名称
