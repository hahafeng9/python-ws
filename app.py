...
# 环境变量
UUID = os.environ.get('UUID', '5d01522a-36cf-4667-94a0-cb345b51841c')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'buildyio.ffeng.kdns.fr')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'buildfyio')                    # 节点名称
